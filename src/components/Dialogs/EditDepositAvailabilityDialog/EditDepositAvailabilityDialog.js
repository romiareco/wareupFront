...
import { EditDepositAvailability } from "../../Deposits";

export function EditDepositAvailabilityDialog({
  selectedDeposit,
  openDialog,
  onDialogOpenChange,
}) {
  ...
  return (
    ...
    >
      <DialogContent>
        ...
        {selectedDeposit && <EditDepositAvailability deposit={selectedDeposit} />}
      </DialogContent>
    </Dialog>
  );
}
